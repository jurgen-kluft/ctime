...
UNITTEST_SUITE_DECLARE(cUnitTest, datetime);
UNITTEST_SUITE_DECLARE(cUnitTest, timer);
UNITTEST_SUITE_DECLARE(cUnitTest, framerate);
UNITTEST_SUITE_DECLARE(cUnitTest, timespan);
