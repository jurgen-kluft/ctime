...
Build {
	...
	Units = function ()
		...
		local unittest = Program {
			...
			Includes = { "source/main/include","source/test/include","../xunittest/source/main/include","../xbase/source/main/include","source/main/include" },
			Depends = { xunittest_library,xbase_library,xtime_library },
		}
		Default(unittest)
	end,
	Configs = {
