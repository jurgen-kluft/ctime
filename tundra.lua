...
Build {
  ...
  Units = function ()
    ...
    local xtime_inc = "source/main/include/"
    ...
    local unittest = Program {
      Name = "xtime_unittest",
      Depends = { xtime_lib, xbase_lib, xunittest_lib },
      Sources = { SourceGlob("source/test/cpp") },
      Includes = { "source/test/include/", xtime_inc, xbase_inc, xunittest_inc },
    }
